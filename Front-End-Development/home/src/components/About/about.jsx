    ...
    return(
        <><div>
            <h3>Sitespeak is a free to use, open source website dedicated to fast communications without censorship
                ...
                Sign up today and join millions of people in a safe environment for  secure communications with friends, family and total strangers! Empower your voice, preserve your privacy, connect freely</h3>
        </div>
